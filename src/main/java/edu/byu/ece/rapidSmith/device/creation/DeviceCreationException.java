...
public class DeviceCreationException extends Exception {
	private static final long serialVersionUID = -7791008441155851875L;
	...
	public DeviceCreationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
		super(message, cause, enableSuppression, writableStackTrace);
	}

	public DeviceCreationException(Throwable cause) {
		super(cause);
	}
}
