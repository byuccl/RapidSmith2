...
public final class Artix7 implements FamilyInfo {

    /* ------ AUTO-GENERATED --- DO NOT EDIT BELOW ------ */
    public static final FamilyType FAMILY_TYPE = FamilyType.valueOf("ARTIX7");
    ...
    public static final class TileTypes {
        ...
        public static final TileType GTP_CHANNEL_1 = TileType.valueOf(FAMILY_TYPE, "GTP_CHANNEL_1");
        ...
        public static final TileType HCLK_TERM_GTX = TileType.valueOf(FAMILY_TYPE, "HCLK_TERM_GTX");
        ...
        public static final TileType VBRK_EXT = TileType.valueOf(FAMILY_TYPE, "VBRK_EXT");

        public static final TileType BRKH_BRAM = TileType.valueOf(FAMILY_TYPE, "BRKH_BRAM");

        public static final TileType R_TERM_INT_GTX = TileType.valueOf(FAMILY_TYPE, "R_TERM_INT_GTX");
        ...
        public static final TileType HCLK_R_BOT_UTURN = TileType.valueOf(FAMILY_TYPE, "HCLK_R_BOT_UTURN");
        ...
        public static final TileType GTP_CHANNEL_2 = TileType.valueOf(FAMILY_TYPE, "GTP_CHANNEL_2");
        ...
        public static final TileType GTP_COMMON = TileType.valueOf(FAMILY_TYPE, "GTP_COMMON");
        ...
        public static final TileType MONITOR_BOT = TileType.valueOf(FAMILY_TYPE, "MONITOR_BOT");

        public static final TileType GTP_INT_INTERFACE = TileType.valueOf(FAMILY_TYPE, "GTP_INT_INTERFACE");
        ...
        public static final TileType PCIE_BOT = TileType.valueOf(FAMILY_TYPE, "PCIE_BOT");

        public static final TileType CMT_PMV_L = TileType.valueOf(FAMILY_TYPE, "CMT_PMV_L");

        public static final TileType GTP_CHANNEL_0 = TileType.valueOf(FAMILY_TYPE, "GTP_CHANNEL_0");
        ...
        public static final TileType MONITOR_TOP = TileType.valueOf(FAMILY_TYPE, "MONITOR_TOP");
        ...
        public static final TileType PCIE_TOP = TileType.valueOf(FAMILY_TYPE, "PCIE_TOP");
        ...
        public static final TileType MONITOR_MID = TileType.valueOf(FAMILY_TYPE, "MONITOR_MID");
        ...
        public static final TileType GTP_CHANNEL_3 = TileType.valueOf(FAMILY_TYPE, "GTP_CHANNEL_3");

        public static final TileType PCIE_INT_INTERFACE_R = TileType.valueOf(FAMILY_TYPE, "PCIE_INT_INTERFACE_R");

        public static final TileType HCLK_L_BOT_UTURN = TileType.valueOf(FAMILY_TYPE, "HCLK_L_BOT_UTURN");
    ...
    public static final class SiteTypes {
        ...
        public static final SiteType GTPE2_CHANNEL = SiteType.valueOf(FAMILY_TYPE, "GTPE2_CHANNEL");
        ...
        public static final SiteType GTPE2_COMMON = SiteType.valueOf(FAMILY_TYPE, "GTPE2_COMMON");

        public static final SiteType IBUFDS_GTE2 = SiteType.valueOf(FAMILY_TYPE, "IBUFDS_GTE2");

        public static final SiteType XADC = SiteType.valueOf(FAMILY_TYPE, "XADC");

        public static final SiteType PCIE_2_1 = SiteType.valueOf(FAMILY_TYPE, "PCIE_2_1");
    ...
    static {
        _GENERATED_FROM.add("xc7a100tcsg324");
        ...
        _TILE_TYPES.add(TileTypes.GTP_CHANNEL_2);
        ...
        _TILE_TYPES.add(TileTypes.GTP_COMMON);
        ...
        _TILE_TYPES.add(TileTypes.MONITOR_BOT);
        _TILE_TYPES.add(TileTypes.GTP_INT_INTERFACE);
        _TILE_TYPES.add(TileTypes.CLK_BUFG_REBUF);
        _TILE_TYPES.add(TileTypes.HCLK_CMT);
        _TILE_TYPES.add(TileTypes.CLK_BUFG_BOT_R);
        _TILE_TYPES.add(TileTypes.PCIE_BOT);
        _TILE_TYPES.add(TileTypes.CMT_PMV_L);
        _TILE_TYPES.add(TileTypes.GTP_CHANNEL_0);
        ...
        _TILE_TYPES.add(TileTypes.MONITOR_TOP);
        ...
        _TILE_TYPES.add(TileTypes.PCIE_TOP);
        _TILE_TYPES.add(TileTypes.CLK_MTBF2);
        _TILE_TYPES.add(TileTypes.CLK_FEED);
        _TILE_TYPES.add(TileTypes.MONITOR_MID);
        ...
        _TILE_TYPES.add(TileTypes.GTP_CHANNEL_3);
        _TILE_TYPES.add(TileTypes.PCIE_INT_INTERFACE_R);
        _TILE_TYPES.add(TileTypes.HCLK_L_BOT_UTURN);
        ...
        _SITE_TYPES.add(SiteTypes.GTPE2_CHANNEL);
        ...
        _SITE_TYPES.add(SiteTypes.GTPE2_COMMON);
        _SITE_TYPES.add(SiteTypes.IBUFDS_GTE2);
        _SITE_TYPES.add(SiteTypes.XADC);
        _SITE_TYPES.add(SiteTypes.PCIE_2_1);
