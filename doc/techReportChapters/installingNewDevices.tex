...
compact RS2 device files (Megabytes instead of Gigabytes) that represent
...
the RS2 ``devices'' folder. For example, the device files generated
...
contains the serialized \texttt{Device} data structures for RS2. The file
...
\item Run the Family Builder in RS2 and pass your part as the command
