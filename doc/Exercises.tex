...
\begin{itemize}
  \item Load the \textit{cordic.tcp} Tincr checkpoint is into RapidSmith (this
...
\noindent Visually verify that you assembled the full adder correctly, and that
the LUTs are correctly initialized.
