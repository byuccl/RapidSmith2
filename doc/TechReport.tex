...
\newcommand{\cellspins}{\cls{CellPin}s\xspace}
...
environment, or build RS2 for use in Eclipse (recommended).
...
\vspace{-0.15in}  \begin{code}
Â  Â  Â gradlew build (unix) Â  Â 
Â  Â  Â gradlew.bat build (windows)
\end{code}
...
\cls{CellNet} is traversed and converted into a Vivado ROUTE string. A user can
use custom data structures to route a design, but it needs to be
